...
export const IconZoomOut: Component<{}> = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class={styles.zoom}>
...
export const IconZoomIn: Component<{}> = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class={styles.zoom}>
